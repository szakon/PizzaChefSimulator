...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v1.10"
  WORKING_DIRECTORY "/home/iris/JIN/jeu_monsieur_madame/cmake-build-debug/_deps/pugixml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/iris/JIN/jeu_monsieur_madame/cmake-build-debug/_deps/pugixml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/iris/JIN/jeu_monsieur_madame/cmake-build-debug/_deps/pugixml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
